...
class GameController {
    ...
    enum class NivelesDificultad{
        FACIL, INTERMEDIO, DIFICIL
    }

    private lateinit var miDificultad : NivelesDificultad

    fun getDifficultyLevel(): NivelesDificultad? {
        return miDificultad
    }

    fun setDifficultyLevel(difficultyLevel: NivelesDificultad) {
        miDificultad = difficultyLevel
    }
